                ...
                <div className='w-full max-w-[862px] md:border-l border-[#CBA77C] md:pl-4'>
                    <div className='w-full'>
                        <div className='flex items-center gap-1'>
                            ...
                            <Link href='/' className='underline text-[#1E1E1E] font-poppins font-normal text-[13px] leading-[20px] tracking-[0.25px]'>Search</Link>
                            <span className='text-[#1E1E1E] font-poppins font-normal text-[13px] leading-[20px] tracking-[0.25px]'>/</span>
                            <p className='text-[#1E1E1E] font-poppins font-normal text-[13px] leading-[20px] tracking-[0.25px]'>Hand made</p>
                        </div>

                        <div className='mt-2 flex xsm:items-end gap-2 justify-between xsm:flex-row flex-col w-full'>
                            <div className='flex items-center gap-2'>
                                <h2 className='mr-[10px] sm:mr-[60px] text-[#1E1E1E] text-[25px] sm:text-[34px] leading-[36px] italic font-montserrat font-normal'>“Hand made”</h2>
